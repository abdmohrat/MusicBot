...
public class JMusicBot 
{
    ...
    private static void startBot()
    {
        ...
        Prompt prompt = new Prompt("MusicBot");
        ...
        try
        {
            ...
            {
                prompt.alert(Prompt.Level.ERROR, "MusicBot", "MusicBot cannot be run on this Discord bot: " + unsupportedReason);
            ...
            {
                LOG.info("MusicBot", "You currently have a custom prefix set. "
    ...
    private static CommandClient createCommandClient(BotConfig config, SettingsManager settings, Bot bot)
    {
        ...
        AboutCommand aboutCommand = new AboutCommand(Color.BLUE.brighter(),
                                "a music bot that is [easy to host yourself!](https://github.com/abdmohrat/MusicBot) (v" + OtherUtil.getCurrentVersion() + ")",
