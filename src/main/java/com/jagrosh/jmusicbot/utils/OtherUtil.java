...
public class OtherUtil
{
    public final static String NEW_VERSION_AVAILABLE = "There is a new version of MusicBot available!\n"
                    + "Current version: %s\n"
                    + "New Version: %s\n\n"
                    + "Please visit https://github.com/abdmohrat/MusicBot/releases/latest to get the latest release.";
    ...
    public static boolean isNewVersionAvailable(String currentVersion, String latestVersion)
    {
        ...
        return normalizedLatest!=null && normalizedCurrent!=null && !normalizedLatest.equalsIgnoreCase(normalizedCurrent);
    }
    ...
    public static String getLatestVersion()
    {
        try
        {
            Response response = new OkHttpClient.Builder().build()
                    .newCall(new Request.Builder().get().url("https://api.github.com/repos/abdmohrat/MusicBot/releases/latest").build())
                    .execute();
